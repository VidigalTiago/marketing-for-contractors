...
interface HeroSectionPTProps {
  onCTAClick: () => void
}

const metrics = [
  { value: 'US$12.8M+', label: 'em Receita Atribuída' },
  { value: '10+ Anos', label: 'em Growth Marketing' },
]

export default function HeroSectionPT({ onCTAClick }: HeroSectionPTProps) {
  return (
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-2">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-[1.05] tracking-tight text-[#0A0A0A] text-balance">
                Consiga Mais Obras Através do Seu Marketing
              </h1>
              <p className="text-xl lg:text-2xl font-semibold text-[#1565D8] text-balance">
                Mais leads qualificados. Mais orçamentos. Mais projetos assinados.
              </p>
            </div>

            {/* Supporting copy */}
            <p className="text-[#667085] text-base lg:text-lg leading-relaxed max-w-lg">
              Ajudo empreiteiros gerais, construtoras e empresas de reforma residencial a conseguirem mais oportunidades reais de projetos por meio de publicidade paga, sistemas de acompanhamento mais eficientes e rastreamento claro de vendas.
            </p>
