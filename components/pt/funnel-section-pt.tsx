...
const funnelSteps = [
  { label: 'Anúncios', sub: 'Tráfego Pago' },
  { label: 'Lead', sub: 'Contato Capturado' },
  { label: 'Orçamento', sub: 'Projeto Detalhado' },
  { label: 'Projeto Assinado', sub: 'Contrato Fechado' },
  { label: 'Receita', sub: 'Dinheiro na Conta' },
]

const problems = [
  'Não saber quais anúncios trazem os melhores clientes',
  'Leads que não viram orçamentos',
  'Orçamentos que não viram projetos assinados',
  'Sem visão clara do ROI de marketing',
  'Leads perdidos por lentidão no acompanhamento',
  'Sem visibilidade sobre os serviços ou regiões mais lucrativos',
]

export default function FunnelSectionPT() {
  return (
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="max-w-3xl mb-16">
          ...
          <h2 className="text-3xl lg:text-4xl font-extrabold tracking-tight text-[#0A0A0A] text-balance mb-2">
            A Maioria dos Empreiteiros Não Tem um Problema de Leads
          </h2>
          <p className="text-2xl lg:text-3xl font-bold text-[#1565D8]">
            Eles têm um problema de sistema.
          </p>
        </div>
